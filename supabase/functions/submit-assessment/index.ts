  ...
  try {
    ...
    const { data, error } = await sb
      ...
      .insert({
        ...
        medications:         body.meds || null,
        activity:            body.activity || null,
        sleep:               body.sleep || null,
        stress:              body.stress || null,
        peptide_experience:  body.prev || null,
...
${row("Metas", g)}
${row("Síntomas", s)}
${row("Medicamentos", body.meds)}
${row("Actividad", body.activity)}
${row("Sueño", body.sleep)}
${row("Estrés", body.stress)}
${row("Experiencia previa", body.prev)}
${row("Protocolo sugerido", body.suggestedProtocol)}
